        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/product-form.php" method="post" enctype="multipart/form-data">
                    ...
                    <a role="button" button class="btn btn-secondary" href="<?php echo $base_url; ?>/index.php"><i class="fa-solid fa-xmark me-1"></i>Cancel</a>
                    <hr class="my-4">
                </form>
            </div>
        </div>
                            ...
                            <?php while ($product = mysqli_fetch_assoc($query)): ?>
                                <tr>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo $base_url; ?>/assets/image/no-image.png<?php echo $product['profile_image']; ?>" width="100" alt="Product Image">
                                        <?php endif;?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are your sure you want delete?');" role="button" href="<?php echo $base_url;?>/product-delete.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-danger"><i class="fa-regular fa-trash-can me-1"></i>Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
